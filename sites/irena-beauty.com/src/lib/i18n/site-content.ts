...
export const SITE_CONTENT_RU: SiteContent = {
  ...
  discountPopup: {
    ...
    description: 'Скидка 10% на первый маникюр с гель-покрытием или на первую процедуру ✨',
...
export const SITE_CONTENT_HE: SiteContent = {
  ...
  discountPopup: {
    ...
    discount: '10%',
    title: 'הנחה על הביקור הראשון',
    description: 'הנחה 10% על מניקור ג׳ל ראשון או על הטיפול הראשון ✨',
